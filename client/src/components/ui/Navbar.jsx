    ...
    <div className="fixed top-0 left-0 right-0 md:px-24 px-4 md:pt-10 flex flex-wrap items-center py-2  bg-transparent z-50 font-semibold animate-y">
      <div >
        <div className="flex flex-row ">
          ...
          {/* desktop navbar */}
      <div
        className="hidden md:flex  md:ml-[480px] md:w-auto w-full"
        id="menu"
      >
        <nav>
        ...
        <div>
          {isOpen && (
            <div className="hidden right-2 absolute rounded-md w-[30%] px-4 top-[10%] bg-slate-300 flex-col max-md:flex  max-md:mt-14">
              <nav>
