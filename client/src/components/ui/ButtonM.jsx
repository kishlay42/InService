...
const ButtonM = ({className, word = "Learn More" }) => {
  return (
    <div>
      {/* effect */}
      <button className={ clsx("py-5 px-8 relative inline-flex items-center justify-start overflow-hidden transition-all bg-[#333333] hover:bg-[#333333] group",className)} >        {/* purple box */}
