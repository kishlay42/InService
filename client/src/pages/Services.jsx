...
const Services = () => {
  const servicesData = [
    ...
    },
    {
      ...
      description: "Security, stability and performance are important factors when it comes to cloud management. InService makes sure your digital product is hosted and fully managed in a market-proven cloud environment.",
      readMoreLink: "#"
    }
  ];
    ...
    <>
      ...
      <section className="md:pb-36 md:mt-36 ">
        ...
        <div className="mt-32 max-md:mt-10 max-md:mr-0.5 max-md:max-w-full lg:ml-40">
          <div  className="animate-y flex flex-wrap gap-20">
